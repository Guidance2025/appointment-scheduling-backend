...
public interface ExitInterviewService {
    List<Questions> createMultipleExitInterviewQuestions(Long guidanceStaffId, List<String> questionTexts, List<Long> selectedStudentIds);    List<Questions> findByGuidanceStaffId(Long guidanceStaffId);
    ...
    List<StudentDetailsResponse> getAllStudentsForSelection();
}